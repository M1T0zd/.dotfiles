...
_G.packer_plugins = {
  ...
  ["auto-session"] = {
    ...
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/auto-session",
  ...
  ["session-lens"] = {
    ...
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/session-lens",
    url = "https://github.com/rmagatti/session-lens"
  },
  ["symbols-outline.nvim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/symbols-outline.nvim",
  ...
  ["twilight.nvim"] = {
    ...
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/twilight.nvim",
